...
$query_rinci_jual="INSERT INTO trincipengambilan (nofaktur,idbarang,namabarang,jumlah,sesi)VALUES ('".$no_faktur."','".$idbarang."','".$namabarang."','".$jml."','USR') ";
...
echo "<script type='text/javascript'> alert('Kode Barang Tidak Terdaftar/Stock Habis!'); document.location.href='../pemakai.php?menu=pengambilan'; </script>;";}}
?>