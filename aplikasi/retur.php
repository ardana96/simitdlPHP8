                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <? $date=date('20y-m');
									   $datee=$date.'%';
									   $sql = mysql_query("SELECT * from tpengambilan,bagian where tpengambilan.bagian=bagian.id_bagian and tpengambilan.tglambil like '$datee'");
				...
				?>
										...
										<td><? echo $tglambil ?></td>
											...
											<td><? echo $divisi ?></td>
											  ...
											  <td class="center">
									<form action="pemakai.php?menu=freturpengambilan" method="post" >
