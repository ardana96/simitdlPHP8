...
$sql = mysql_query("SELECT * FROM bagian_pemakai where id_bag_pemakai='$id_bag_pemakai'");
...
function kdauto($tabel, $inisial){
    ...
    <div class="inner">
		    <div class="row">
                    <div class="col-lg-12">
                        <h1> EDIT BAGIAN untuk Perawatan PC</h1>
						<hr>
                    </div>
                </div>
			   <div class="row">
...
?> 
   ...
   <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="id_bag_pemakai" value="<? echo $id_bag_pemakai ?>" readonly>
                                    
                                        </div>
											
<div class="form-group">
                                           
                                            <input  class="form-control" type="text" name="bag_pemakai" value="<? echo $bag_pemakai ?>" >
            ...
            <button  name="button_tambah" class="btn text-muted text-center btn-primary" type="reset">Reset</button>
									...
									<br>
									<a href="user.php?menu=bagian_pemakai"><button  name="tombol" class="btn text-muted text-center btn-primary" type="submit">Daftar Bagian</button></a>
                            </div>
                        </div>
                            </div>
                </div>
