...
http.send(null);
 ...
 function permintaanId(idpc){
if(idpc==""){
alert("Anda belum memilih ippc  !");}
else{  
http.open('GET', 'aplikasi/filteridpc.php?idpc=' + encodeURIComponent(idpc) , true);
http.onreadystatechange = handleResponse;
http.send(null);
 }}
...
<input name="status" type="hidden" value="PENDING">
	  ...
	  Tanggal Request
                    <input  type="text" name="tglRequest"  value='<? echo $tanggal;?>' required="required"> <br> <br>
									...
									ID PC  
                                            <input class="form-control" type="text" name="idpc"  value='' onchange="new permintaanId(this.value)" >
