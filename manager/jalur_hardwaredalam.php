...
<form action="lap_hardware.php"   method="POST" id="input_form" >
<table >
<tr>
<td colspan="3" align="center" class="judul">SERVICE HARDWARE PDF</td>
</tr>
 <tr>
 <td>Bulan / tahun</td>
 <td> :</td>
...
<form action="../excel/servicedalam_excel.php"   method="POST" id="input_form">
<table>
<tr>
<td colspan="3" align="center" class="judul">SERVICE HARDWARE EXCEL</td>
</tr>
<tr>
 <td>Bulan / tahun</td>
 <td> :</td>
