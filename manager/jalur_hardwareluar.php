...
<form action="lap_hardwarekeluar.php"   method="POST" id="input_form" >
<table >
<tr>
<td colspan="3" align="center" class="judul">SERVICE HARDWARE KELUAR PDF</td>
</tr>
 <tr>
 <td>Bulan / tahun</td>
 <td> :</td>
...
<form action="../excel/serviceluar_excel.php"   method="POST" id="input_form">
<table>
<tr>
<td colspan="3" align="center" class="judul">SERVICE HARDWARE KELUAR EXCEL</td>
</tr>
<tr>
 <td>Bulan / tahun</td>
 <td> :</td>
