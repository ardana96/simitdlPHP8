<?php
require('kop_perawatanbaru2.php');
...
$pdf->SetWidths(array(7,20,20,21,22,55,10,10,10,10,15,15,15,15,15,10,15));
...
$sql=mysql_query("Select * from pcaktif2 where bulan like'%".$bulan."%' and divisi like '%".$pdivisi."%' order by nomor ");
...
$pdf->Row(array($no++,$tgl_jadwal2,'',$bagianbesar,$ippc,$namapc.'/'.$user,$osbesar,$appsbesar,'',$cpubesar,$monitorbesar,$printerbesar,'','',$petugas,$a,$keterangan));
}}
$pdf->Output();
?>
