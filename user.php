        ...
        <div id="content">
            ...
            if (isset($_GET['menu'])) {
                ...
                switch ($menu) {
                    ...
                    case 'rpemakaipc': include('aplikasi/pemakaipc/index.php'); break;
                    ...
                    case 'fupdate_pemakaipc2': include('aplikasi/stockopname/fupdate_pemakaipc2.php'); break;
                    case 'fupdate_pemakaipcNew': include('aplikasi/pemakaipc/modals/fupdate_pemakaipc2.php'); break;
                    ...
                    case 'scanopname': include('aplikasi/stockopname/scanqr/index.php'); break;
                }
            }
            ?>
        </div>
