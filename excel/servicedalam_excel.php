...
header("Content-Disposition: attachment; filename=servicedalam.xls");
...
<table width="100%" cellpadding="3" cellspacing="0" border="1">
    <tr>
        <th align="center" colspan="9">
            <h4 align="right">FM-IT.00-25-003/R2</h4>
            <h2>PERMINTAAN PERBAIKAN PERANGKAT KOMPUTER</h2>
        </th> 
    </tr> 
    <tr class="warna">
        <th>No</th>
...
$sql = "SELECT 
    ...
    a.svc_kat AS kategori, -- Pastikan kolom ini ada di tabel
...
while ($database = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    ...
    $kategori = isset($database['kategori']) ? $database['kategori'] : '';

    $tgl = isset($database['tgl']) ? $database['tgl']->format('d-m-Y') : '';
    $tgl2 = isset($database['tgl2']) ? $database['tgl2']->format('d-m-Y') : '';
    $nama = $database['nama'];
    ...
    $kategori_text = ($kategori == "NON_SP") ? "NON SPAREPART" : (($kategori == "SP") ? "SPAREPART" : "-");
